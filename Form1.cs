...
namespace iksoks
{
    public partial class Form1 : Form
    {
        ...
        {
            MessageBox.Show("IksOks\nNapravljeno iz dosade\nDimitrije Šovljanski\n©Novembar 2022.");
      
  }

        private void kakoSeIgraToolStripMenuItem_Click(object sender, EventArgs e)
        {
            MessageBox.Show("IksOks je igra za dva igrača koja se igra na polju 3x3 kvadrata.\nIgrači naizmenično postavljaju svoje znakove\n(jedan koristi ikseve, drugi kružiće) u slobodna polja.\nCilj igre je spojiti tri znaka vodoravno, uspravno ili dijagonalno");
        }
    }
}